...
const AUTOMATION_TASK_DEFINITIONS = [
    {
        agentKey: 'frontend',
...
export class Orchestrator extends EventEmitter {
    ...
    Respond with JSON:
    {
      ...
      "reasoning": "brief explanation"
        ...
        try {
            const response = await this.modelRouter.execute('planning', analysisPrompt, {
     ...
     */
    async executeWorkflow(workflowId, initialInput) {
        ...
        for (const step of workflow.steps) {
            ...
            try {
                ...
                if (step.agentName) {
                    ...
                    const modelResponse = await this.modelRouter.execute(step.taskType, typeof currentInput === 'string' ? currentInput : JSON.stringify(currentInput), {
        ...
        try {
            ...
            switch (routing.approach) {
                ...
                default: {
                    ...
                    const response = await this.modelRouter.execute('planning', // Default task type
                    input, {
    ...
    buildAutomationTasks(featureDescription, config) {
    ...
    async automateFeatureDevelopment(featureDescription) {
        ...
        for (const task of tasks) {
            ...
            try {
                ...
                const response = await this.modelRouter.execute(task.taskType, task.prompt, {
    ...
    getMetrics() {
        ...
        const agentHealthStatus = new Map();
     ...
     */
    getSystemHealth(agentHealthStatus) {
        let healthyAgents = 0;
