  ...
  const docSections: DocSection[] = [
    {
      ...
      description: 'Everything you need to know to get up and running with Aurora Interface',
      ...
      items: [
        {
          ...
          description: 'Install Aurora Interface and configure your development environment',
          readTime: '5 min',
          difficulty: 'beginner',
          updated: '2 days ago',
          popular: true
        ...
        },
        {
          ...
          description: 'Learn about agents, workflows, and the Aurora architecture',
          readTime: '8 min',
          difficulty: 'beginner',
          updated: '3 days ago'
        }
      ...
      items: [
        {
          ...
          description: 'Optimize your Aurora setup for maximum performance',
          readTime: '25 min',
          difficulty: 'advanced',
          updated: '3 days ago'
        },
        {
          ...
          description: 'Secure your Aurora deployment for production use',
          readTime: '30 min',
          difficulty: 'advanced',
          updated: '1 week ago'
        },
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Comprehensive guides and API reference for Aurora Interface
          </p>
        </div>
