...
export const Components: React.FC = () => {
  ...
  const components: ComponentExample[] = [
    {
      ...
      name: 'Primary Button',
      category: 'buttons',
      description: 'Main action button with Aurora orange styling',
  ...
  Danger Action
    ...
    },
    {
      ...
      name: 'Text Input',
      category: 'forms',
      description: 'Standard text input with Aurora focus styling',
      code: `<input
  type="text"
...
/>`,
    ...
    },
    {
      ...
      category: 'forms',
      description: 'Dropdown select with Aurora styling',
  ...
  <option>Option 3</option>
    ...
    },
    {
      ...
      name: 'Checkbox',
      category: 'forms',
      description: 'Custom styled checkbox with Aurora colors',
  ...
  Error
    ...
    },
    {
      ...
      name: 'Card',
      category: 'layout',
      description: 'Basic card container with Aurora styling',
  ...
  <div className="flex">
    ...
    },
    {
      ...
      name: 'Progress Bar',
      category: 'feedback',
      description: 'Progress indicator with Aurora orange color',
  ...
  <span className="text-sm text-gray-600 ml-2">4.0</span>
    ...
    },
    {
      ...
      name: 'Toggle Switch',
      category: 'forms',
      description: 'Toggle switch with Aurora styling',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Explore and use components from the Aurora Design System
          </p>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Aurora Color Palette</h2>
