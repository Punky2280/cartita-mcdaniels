...
export const Context7: React.FC = () => {
  ...
  const documents: Documentation[] = [
    ...
    {
      id: '2',
      title: 'Getting Started with Aurora Interface',
      description: 'Step-by-step guide to setting up and configuring your Aurora Interface for AI agent orchestration',
      category: 'guide',
      type: 'manual',
      status: 'published',
    ...
    },
    {
      ...
      description: 'Latest features, improvements, and bug fixes in Aurora Interface version 3.2.1',
      category: 'changelog',
      type: 'manual',
      status: 'published',
