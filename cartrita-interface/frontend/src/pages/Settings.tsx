      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Configure your Cartrita Interface preferences and system settings
          </p>
        </div>
      ...
      >
        <div className="space-y-6">
          ...
          <ToggleSwitch
            ...
            description="Help improve Cartrita by sharing anonymous usage data"
          />
      ...
      <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
          <div>
            ...
            <span className="text-gray-600 ml-2">Cartrita Interface v3.2.1</span>
          </div>
          <div>
