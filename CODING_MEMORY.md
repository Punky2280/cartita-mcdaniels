...
> This memory file should be referenced by all agents working on the Cartrita project to ensure consistent, modern, and secure coding practices aligned with 2025 standards.